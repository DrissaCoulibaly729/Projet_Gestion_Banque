		...
		<div class="error-top">
			...
			<div class="login">
				...
				<form  onsubmit="return validateForm();" method="post" action="index.php">
					...
					<div class="submit"><input type="submit" onsubmit="validateForm()" value="Login" name="loginCais"></div>
					<div class="clearfix"></div>

					<div class="new">
						<p><a href="index.php?page=interAuth/forgotPassword&message=reisca120">Forgot Password?</a></p>
